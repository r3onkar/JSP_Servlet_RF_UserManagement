...
<body>
            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #80ced6">
                    <div>
                        <a href="https://www.javaguides.net" class="navbar-brand" style="color: #lightgrey"> User Management App </a>
                        <a href="https://www.javaguides.net/home"></a>
                    </div>
